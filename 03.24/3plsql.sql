...
5. Írjon egy olya PL/SQL programot, amely a beosztás rövidítése alapján megadja, a dolgozó teljes beosztását. 
(vezerles4.sql) pl. beosztas= 'root', ez alaőján kiírja : Rendszergazda(UNIX/LINUX)
